...
public class AuthenticationInterceptor  implements HandlerInterceptor {
    ...
    public AuthenticationInterceptor(OAuthService oAuthService){ this.oAuthService = oAuthService; }
    ...
    public boolean preHandle(
        ...
        if(!oAuthService.validateToken(authentication)){ throw new InvalidTokenException(); }
