...
public enum HttpMethodMapper {
    ...
    public static HttpMethod findHttpMethodByControllerMethod(Method method) {
        return Arrays.stream(values())
                ...
                .findAny()
                .orElseThrow(() -> new IllegalArgumentException("The http method that matched one is not exists."));
    }
    ...
    public static Class<? extends Annotation> findAnnotatedHttpMethodAnnotation(Method method) {
        return Arrays.stream(values())
                ...
                .findAny()
                .orElseThrow(() -> new IllegalArgumentException("The http methodAnnotation that matched one is not exists."));
    }
