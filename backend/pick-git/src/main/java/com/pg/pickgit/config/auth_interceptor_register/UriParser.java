package com.pg.pickgit.config.auth_interceptor_register;

import com.pg.pickgit.config.auth_interceptor_register.register_type.RegisterType;
...
import com.pg.pickgit.config.auth_interceptor_register.scanner.HttpMethodMapper;
import com.pg.pickgit.config.auth_interceptor_register.scanner.data_structure.InterceptorParameter;
import com.pg.pickgit.config.auth_interceptor_register.scanner.data_structure.MergedInterceptorParameterByMethod;
...
public class UriParser {
    ...
    private List<MergedInterceptorParameterByMethod> createMergedInterceptorParameterByMethods(
        ...
        prefixUrlsFromController.forEach(
                prefix -> mergedInterceptorParameterByMethods.addAll(
                        createMergedInterceptorParameterByMethods(interceptorParameters, prefix)
                )
        );
    ...
    private List<String> parseUrlsFromMethod(Method method) { return HttpMethodMapper.extractMappingValues(method); }
