...
public class User {
    ...
    public User(BasicProfile basicProfile, GithubProfile githubProfile){ this(null, basicProfile, githubProfile); };
    ...
    public void updateProfileImage(String imageUrl){ this.basicProfile.setImage(imageUrl); }
    ...
    public Boolean isFollowing(User targetUser){
        if(this.equals(targetUser)){ return null; }
        return this.followings.isFollowing(targetUser);
    }

    public void changeGithubProfile(GithubProfile githubProfile){ this.githubProfile = githubProfile; }

    public void delete(Post post){
        if(post.isNotWrittenBy(this)){ throw new PostNotBelongToUserException(); }
